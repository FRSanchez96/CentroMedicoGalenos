							...
							<div class="login-grids">
									<div class="login-bottom" >
										...
										<form action="Registrar" method="post">
											...
											<div class="sign-up">
												<h4>Digito Verificador :</h4>
                                                                                                <input type="text" name="txtNombre" value="" required="">
												
											</div>
                                                                                    
                                                                                        <div class="sign-up">
												<input type="submit" name="btnCrear" value="VER" >
											</div>
                                                                                </form>
			</div>
							...
							<div class="login-grids">
									...
									<div class="login-right">
										...
										<form action="Login" method="post">
											...
											<div class="sign-in">
                                                                                            <input type="submit" value="Logear" name="btnLogear" >
											</div>
										</form>
									</div>
