...
<html>
<head>
<title>Anular Hora Centro Medico Galenos</title>
<!-- for-mobile-apps -->
...
<div class="gallery">
	<div class="container">
		<h3 class="tittle">Anular Hora </h3>
              ...
              <tbody>
                 ...
                 %>
                                    <tr>
                                      ...
                                      <td><%=tmpi.getSum()%></td>
                                      <td><input type="submit" value="Anular Hora" onclick="location='../IngresarHora?btnLogear=Anular&numAtencion=<%=tmpi.getId_Aten()%>&Descripcion=<%=tmpi.getDescripcion()%>&Costo=<%=tmpi.getCosto()%>&IdAgen=<%=tmpi.getId_Agen()%>&Hora=<%=tmpi.getHora()%>&RutPa=<%=tmpi.getPaciente_Rut()%>&Esp=<%=tmpi.getId_Espe()%>&IdBole=<%=tmpi.getId_Bole()%>&SumTo=<%=tmpi.getSum()%>&Estado=<%=tmpi.getEstado()%>'" ></td>
                                    </tr>
                <%
                                 }
                             }
