...
<html>
<head>
<title>Tomar Hora Centro Medico Galenos</title>
<!-- for-mobile-apps -->
...
<div class="gallery">
	<div class="container">
		<h3 class="tittle">Tomar Hora </h3>
                <h3 class="tittle">¿Qué clase de hora desea tomar?</h3>
		...
		<div class="col-md-3 capabil_grid2 wow fadeInUpBig animated animated text-center" data-wow-delay="0.4s">
			<div class="capil_text">
				<div class='numscroller numscroller-big-bottom'></div>
                                <p><a href="MedicoEsp.jsp">Tomar hora Medico Especifico</a></p>	
			</div>
		</div>
                <div class="col-md-3 capabil_grid3 wow fadeInDownBig animated animated text-center" data-wow-delay="0.4s" >
			<div class="capil_text">
				<div class='numscroller numscroller-big-bottom'></div>
                                <p><a href="Rapida.jsp">Tomar hora Sucursal Especifica</a></p>	
			</div>
		</div>
