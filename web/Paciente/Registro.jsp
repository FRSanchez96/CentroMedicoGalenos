...
<html>
<head>
<title>Registro de Hora Centro Medico Galenos</title>
<!-- for-mobile-apps -->
...
<div class="gallery">
	<div class="container">
		<h3 class="tittle">Registro de Horas </h3>
                <h3 class="tittle">¿Qué desea hacer?</h3>
