...
<div class="gallery">
	<div class="container">
		<h3 class="tittle">Tomar Hora Rapida</h3>
                            ...
                            <div class="content">
                                <div class="container">
                                    <div id="book" class="col-md-4 content_middle wow flipInY" data-wow-duration="1.0s" data-wow-delay="0.3s">
                                        ...
                                        <select id="cbxCen"  name="cbxCen" class="frm-field required sect" onchange="funCbxCen()">
                                        ...
                                        <select id="cbxPro"  name="cbxPro" class="frm-field required sect" onchange="funCbxPro()">
                                            <option value="#">Seleccione su opcion</option>
                                                 <%
                                                    for(Doctor tmap:Ldo)
                                                    {
                                        ...
                                        <select id="cbxEsp"  name="cbxEsp" class="frm-field required sect" onchange="funCbxEsp()">
                                            <option value="#">Seleccione su opcion</option>
                                                <%
                                                    for(Especialidad tmk:Les)
                                                        {

                                                %>
                                                    <option value="<%=tmk.getId_Espe()%>"> <%=tmk.getNombre_Esp()%> </option>
                                                <%
                                                        }
                                                %>                                                                                                     
                                        </select>
...
<script>
    function funCbxCen(){
       ...
       // location.href="/Examen/Paciente/Rapida.jsp?suc=" + document.getElementByTagName("cbxCen").value;
          $.ajax({  type: "POST"  // Typo GET o POST
                ,  url: "/Examen/Paciente/Rapida_pro.jsp"    // Nombre del HTML
		...
		// si funciona pasa por succes
                , data: "CentroMedi=" + document.getElementById("cbxCen").value + ""
		,  success: function (response) {
                    stRespuesta = response;
                   // alert(stRespuesta);
                    document.getElementById("cbxPro").innerHTML= stRespuesta;
                   // alert(888);
		}
    ...
    function funCbxPro(){
       ...
       // location.href="/Examen/Paciente/Rapida.jsp?suc=" + document.getElementByTagName("cbxCen").value;
          $.ajax({  type: "GET"  // Typo GET o POST
                ,  url: "/Examen/Paciente/Rapida_esp.jsp"    // Nombre del HTML
		,  async: false   // asincrónico en false o sea sincrónico
		,  cache: false   // Cache en False, así obligamos a buscar la página
		// si funciona pasa por succes
    ...
    function funCbxEsp(){
       ...
       // location.href="/Examen/Paciente/Rapida.jsp?suc=" + document.getElementByTagName("cbxCen").value;
          $.ajax({  type: "GET"  // Typo GET o POST
                ,  url: "/Examen/Paciente/Rapida_hora.jsp"    // Nombre del HTML
		,  async: false   // asincrónico en false o sea sincrónico
		,  cache: false   // Cache en False, así obligamos a buscar la página
		// si funciona pasa por succes
