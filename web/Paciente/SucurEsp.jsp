...
<div class="gallery">
	<div class="container">
		<h3 class="tittle">Tomar Hora con Sucursal Especifica </h3>
                            ...
                            <div class="content">
                                <div class="container">
                                    <div id="book" class="col-md-4 content_middle wow flipInY" data-wow-duration="1.0s" data-wow-delay="0.3s">
                                        ...
                                        <h4>Prevision :</h4>
                                        <select id="cbxPre"  name="cbxPre" class="frm-field required sect">
    ...
    function funCbxCen(){
       ...
       // location.href="/Examen/Paciente/Rapida.jsp?suc=" + document.getElementByTagName("cbxCen").value;
		...
		// si funciona pasa por succes
                , data: "cenmed=" + document.getElementById("cbxCen").value + ""
