				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--horatio">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item menu__item--current"><a href="Ayuda.jsp" class="menu__link">Ayuda en Linea</a></li>
						</ul>
					</nav>
				</div>
			</nav>
						...
						<div class="row form-group">
							<div class="col-md-12">
								<!-- <label for="lname">Last Name</label> -->
                                                                <input type="email"  required="" name="para" class="form-control" placeholder="Tu Correo">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								<!-- <label for="subject">Subject</label> -->
                                                                <input type="text" required="" name="asunto" class="form-control" placeholder="Titulo del Mensaje">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								<!-- <label for="message">Message</label> -->
                                                                <textarea  name="mensaje" cols="30" rows="10" required="" class="form-control" placeholder="Tu Mensaje"></textarea>
							</div>
						</div>
