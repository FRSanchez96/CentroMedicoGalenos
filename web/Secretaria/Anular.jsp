                            ...
                            <div class="content">
                                <div class="container">
                                    <div id="book" class="col-md-4 content_middle wow flipInY" data-wow-duration="1.0s" data-wow-delay="0.3s">
                                        <h4>Ingrese Rut del paciente (19223151-5):</h4>
                                            <div class="sign-up">
                                             <input type="text" name="txtRut" maxlength="8" style="WIDTH: 150px; " value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Rut';}" required="">
                                              <input type="text" name="txtDig" maxlength="1" value="" style="WIDTH: 80px; " onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'DV';}" required="">
                                            </div>     
                                        
                                            <div class="sign-up">
                                                <input type="submit" name="btnLogear" value="BUSCAR" >
                                            </div>                                           
                                     </div>
                                 </div>
                           </div>
