...
<html>
<head>
<title>Especialistas Centro Medico Galenos</title>
<!-- for-mobile-apps -->
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--horatio">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item menu__item--current"><a href="Especialista.jsp" class="menu__link">Especialistas</a></li> 
							...
							<li class="menu__item"><a href="Ayuda.jsp" class="menu__link">Ayuda en Linea</a></li>
                                                        ...
                                                        <li class="menu__item"><a href="Registro.jsp" class="menu__link">Horas</a></li>
						</ul>
					</nav>
				</div>
			</nav>
...
<div class="gallery">
	<div class="container">
		<h3 class="tittle">Especialistas </h3>
